...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 43), __webpack_require__(/*! ./../webpack/buildin/module.js */ 342)(module)))
...
module.exports = __webpack_require__(/*! C:\Users\shady\Desktop\game\src\main.js */332);
...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, window.innerWidth * window.devicePixelRatio, window.innerHeight * window.devicePixelRatio, _phaser2.default.CANVAS, 'content', null));
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function preload() {
      ...
      this.game.load.tilemap('MyTilemap', './assets/images/topdown-shooter/maptest.json', null, _phaser2.default.Tilemap.TILED_JSON);
...
var _Character = __webpack_require__(/*! ../sprites/Character */ 341);

var _Character2 = _interopRequireDefault(_Character);

var _Enemy = __webpack_require__(/*! ../sprites/Enemy */ 344);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'create',
    value: function create() {
      var bannerText = 'BEST SHOOTER 2017';
      ...
      var layer = map.createLayer('MyTerrain');
      layer.resizeWorld();
      layer.wrap = true;
      layer.debug = true;
    ...
    key: 'treeOverlapHandler',
    value: function treeOverlapHandler() {
    ...
    value: function update() {
      ...
      this.enemy.body.velocity.x = this.movementFactor * 80;
...
var _lodash = __webpack_require__(/*! lodash */ 128);

var _ = _interopRequireWildcard(_lodash);

var _Keymap = __webpack_require__(/*! ../models/Keymap */ 343);
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    _this.bullets.physicsBodyType = _phaser2.default.Physics.ARCADE;
    _this.bullets.createMultiple(1, 'bullet');
    _this.bullets.setAll('checkWorldBounds', true);
    _this.bullets.setAll('outOfBoundsKill', true);
    _this.bullets.setAll('scale.x', 0.01);
    _this.bullets.setAll('scale.y', 0.01);

    _this.cursors = _this.game.input.keyboard.createCursorKeys();
    _this.myMap = new _Keymap.Keymap(_this.game.input.keyboard, _Keymap.defaultKeymap);

    _this.walk = game.add.audio('grassWalk');
    _this.bulletShot = game.add.audio('bulletShot');
    return _this;
  }
  ...
  _createClass(_class, [{
    ...
    value: function update() {
      ...
      if (this.myMap.isDown(_Keymap.ACTIONS.UP)) {
        this.y -= 5;
        this.walk.play('', 0, 1, false, false);
      } else if (this.myMap.isDown(_Keymap.ACTIONS.DOWN)) {
        this.y += 5;
        this.walk.play('', 0, 1, false, false);
      } else if (this.myMap.isDown(_Keymap.ACTIONS.LEFT)) {
        this.x -= 5;
        this.walk.play('', 0, 1, false, false);
      } else if (this.myMap.isDown(_Keymap.ACTIONS.RIGHT)) {
        this.x += 5;
        this.walk.play('', 0, 1, false, false);
      }
...
exports.Keymap = exports.defaultKeymap = exports.ACTIONS = undefined;
...
};var defaultKeymap = exports.defaultKeymap = (_defaultKeymap = {}, _defineProperty(_defaultKeymap, ACTIONS.LEFT, [_phaser2.default.KeyCode.A, _phaser2.default.KeyCode.LEFT]), _defineProperty(_defaultKeymap, ACTIONS.UP, [_phaser2.default.KeyCode.W, _phaser2.default.KeyCode.UP]), _defineProperty(_defaultKeymap, ACTIONS.RIGHT, [_phaser2.default.KeyCode.D, _phaser2.default.KeyCode.RIGHT]), _defineProperty(_defaultKeymap, ACTIONS.DOWN, [_phaser2.default.KeyCode.S, _phaser2.default.KeyCode.DOWN]), _defineProperty(_defaultKeymap, ACTIONS.BASIC_ATTACK, _phaser2.default.KeyCode.CONTROL), _defaultKeymap);
// Create Keymap class
var Keymap = exports.Keymap = function Keymap(keyboard) {
  this.map = {};
  var self = this;
  _.forEach(defaultKeymap, function (KeyCode, action) {
    self.map[action] = [];
    if (_.isArray(KeyCode)) {
      _.forEach(KeyCode, function (code) {
...
Keymap.prototype.isDown = function (action) {
  for (var i = 0, length = this.map[action].length; i < length; i++) {
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    return _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x, y, asset));
  }
  ...
  _createClass(_class, [{
    ...
    value: function update() {
      //  Check collisions
      // this.game.physics.arcade.overlap(this, this.game.bullets, this.hitEnemy, null, this)
    }
  }]);
